...
\begin{enumerate}
  \begin{figure}[h!]
    \includegraphics[width=\linewidth]{figures/Menu_list.png}
    \caption{Menu management}
    \label{fig:mockup}
  \end{figure}
  \item Client could see menu list of the store
  \begin{figure}[h!]
    \includegraphics[width=\linewidth]{figures/Add_menu.png}
    \caption{Add Menu}
    \label{fig:mockup}
  \end{figure}
...
\begin{enumerate}
  \begin{figure}[h!]
    \includegraphics[width=\linewidth]{figures/OrderList.png}
    \caption{Order List}
    \label{fig:mockup}
  \end{figure}
  \item Clients could see order lists in a page
  \begin{figure}[h!]
    \includegraphics[width=\linewidth]{figures/OrderHistory.png}
...
\begin{table}[ht!] \renewcommand\arraystretch{1.25}
  \begin{threeparttable}
    ...
    \midrule
      ...
      /api/common & baseResult.js,http_status_enum.js,identifyStore.js,onEvent.js & - \\
      /config & sequelize.json & - \\
      /models & index.js,MENU_TB.js,ORDERITEM_TB.js,ORDERS_TB.js,STORE_TB.js,USER_TB.js & Sequelize \\
      /bin	& www.js	& Express \\
      .	& app.js,Dockerfile	& Express,bodyParser,express-list-endpoints \\
      \bottomrule
      \end{tabular}
  \end{threeparttable}
\end{table}
