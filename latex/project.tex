...
Role assignments is shown in Table~\ref{tab:table1}\ . Note that each project participants periodically switched their roles with the others to apply different perspectives and improve their expriences.

\begin{table}[h] {\renewcommand\arraystretch{1.25}
\begin{tabular}{|l|l|l|l|} \hline
\bf Role & \bf Assignee & \bf \multicolumn{1}{l}{Description} \\ \hline
...
\label{tab:table1}
\end{table}
% https://goodtogreate.tistory.com/entry/LaTex-사용-Tip-정리
...
\subsubsection{Voice Preprocessing and Noise Removal}
\begin{enumerate}
...
\subsubsection{Convert preprocessed speech into text data(Speech-To-Text)}
\begin{enumerate}
...
\subsubsection{Extract order data from text data}
\begin{enumerate}
...
\subsubsection{Validate Extracted Order Data}
\begin{enumerate}
...
\subsubsection{PoS: Point of Sales System}
\begin{enumerate}
